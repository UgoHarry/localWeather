...
function usePos(pos) {
    ...
    $.getJSON("https://maps.googleapis.com/maps/api/geocode/json?latlng=" + latty + "," + longy + "&key=AIzaSyDrfePQm_-aWlNAfmMCYFj_Ttcf-gTDR4k", function(data) {
    ...
    $.getJSON("https://api.forecast.io/forecast/f71aa9a934cae5a44df6f8d0df4f0fcc/" + latty + "," + longy + unitTemp , function(data) {
        console.log(data);
